...
################################################################################################################################
	...
	plog(hoy)
	extWeb=r"**/C:/Users/mostrador/Downloads/wc-product-export-"+hoy+r"*.csv"
	...
	FROM [HCLLAVALLOL2001].[dbo].[GVA17] G
	INNER JOIN [HCLLAVALLOL2001].[dbo].[STA11] S
	...
	datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001600000000641')]
	datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001600000000642')]
	datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001600000000643')]
	datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001600000000661')]
	datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001600000000670')]
	datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001600000000671')]
	datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001600000000672')]
	datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001600000000680')]
	datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001600000000681')]
	datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001600000000682')]
	datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001600000000690')]
	datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001600000000691')]
...
try: 
	...
	logErrores('C:/Users/mostrador/Documents/ProgramasPython/WC-ControlPreciosTangoVsWeb/Log/CPTW_')
