...
################################################################################################################################
	...
	OR G.COD_ARTICU LIKE '011500000000060'
	OR G.COD_ARTICU LIKE '011500000000070'
	OR G.COD_ARTICU LIKE '011500000000110'
	...
	#print("datosWebSoloU")
	print("SoloU sin -U: ",len(datosWebSoloU))
	# pd.options.display.float_format = '{:.2f}'.format
	# pd.set_option('display.max_rows', None)
	# print(datosWebSoloU)
	...
	print("Solo KG sin duplicados: ",len(datosWebLimpios))
	# print(datosWebLimpios)
	...
	print("Todos: ",len(datosWebLimpios))
	#print(datosWebLimpios)
	...
	print("Publicado: ",len(datosWebPublicado))
	...
	print("DWOrdenados: ",len(datosWeb))
	#print(datosWeb)
