...
################################################################################################################################
	...
	server='IRONSERVER\\HIERROS1'  #localhost,1183  #puerto 1183
	database='HCLLAVALLOL2001' 
	username='testuser' 
	password='usertest' 
	query="""
	...
	datosWebLimpios=datosWebCsv[~datosWebCsv['SKU'].str.endswith('-U')]		#ELIMINA -U
	...
	# #SACAR DE LISTADO WEB PRODUCTOS DESACTIVADOS/INACTIVOS EN TANGO:
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('068200000000050')]
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('068200000000055')]
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('068200000000060')]
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('068200000000070')]
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('068200000000080')]
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('068300000000080')]
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('068400000000030')]
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('032900000000070')]
	# #HASTA ACA OK, se desactivaron todos en la web.
	# #220427 Fer desactiva los productos a pedido de KariC: 080000000000130 080000000000140
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('080000000000130')]
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('080000000000140')]
	# #HASTA ACA OK, se desactivaron todos en la web.
	# #220517 Se inhabilitan los productos: 001600000000641 001600000000642 001600000000643 001600000000661 001600000000670 001600000000671 001600000000672 001600000000680 001600000000681 001600000000682 001600000000690 001600000000691
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001600000000641')] #OK
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001600000000642')] #OK	
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001600000000643')] #OK
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001600000000661')] #OK
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001600000000670')] #OK 
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001600000000671')] #OK
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001600000000672')] #OK
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001600000000680')] #OK
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001600000000681')] #OK
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001600000000682')] #OK
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001600000000690')] #OK
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001600000000691')] #OK
	# #220615 Se inhabilitan los productos: 
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001500000001062')] #OK
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001500000001063')] #OK
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001500000001064')] #OK
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001500000001065')] #OK
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001500000001070')] #OK
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001500000001145')] #OK
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001700000001333')] #OK
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001700000001334')] #OK
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001700000001335')] #OK
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001700000001340')] #OK
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001700000001341')] #OK
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001700000001342')] #OK
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001700000001343')] #OK
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001700000001350')] #OK
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001700000001351')] #OK
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001700000001352')] #OK
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001700000001360')] #OK 
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001700000001361')] #OK
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001700000001362')] #OK
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001700000001370')] #OK
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001700000001371')] #OK
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001700000001372')] #OK
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001700000001400')] #OK
	# datosWebLimpios=datosWebLimpios[~datosWebLimpios['SKU'].str.endswith('001700000001401')] #OK
	...
	# print("El siguiente codigo Tango no está en la web: ")
	# for cod in listaCod:
	# 	if cod not in listaSku:		#CONSULTA LO QUE ES TANGO PERO NO ESTA EN LA WEB
	# 		cont+=1
	# 		print(cod)
	# if cont>0:
	# 	print("Cantidad de productos de Tango que no están en la Web: ",cont)


	# print("El siguiente sku Web no está activo en Tango: ")
	# for sku in listaSku:
	# 	if sku not in listaCod:		#CONSULTA LO QUE ES WEB PERO NO ESTA EN TANGO
	# 		cont+=1
	# 		print(sku)
	# if cont>0:
	# 	print("Cantidad de productos de Web que no están en Tango: ",cont)

#CUANDO HAY ALGO MAL, VERIFICAR UNO A UNO SKU-COD:
	# for i in range(0,len(listaCod)):
	# 	print(listaSku[i],listaCod[i])
